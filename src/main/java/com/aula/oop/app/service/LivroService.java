...
import com.aula.oop.app.exceptions.LivroDuplicado;
...
public class LivroService  {
    ...
    public LivroResponseDTO addLivro(LivroRequestDTO dto) {
        ...
        if (exists) {
            throw new LivroDuplicado("Código já registrado " + dto.getCodigo());
        }
    ...
    public LivroResponseDTO atualizaLivro(Long id, LivroRequestDTO dto) {
        ...
        if (codigoExists) {
            throw new LivroDuplicado("Código já usado por outro livro");
        }
